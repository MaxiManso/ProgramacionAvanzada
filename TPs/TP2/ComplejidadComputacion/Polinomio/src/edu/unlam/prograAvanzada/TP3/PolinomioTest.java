...
public class PolinomioTest {
	...
	public void calcularPolinomioDeGrado3MSucesivas() {
		...
		assertEquals(10.0, pol.evaluarMsucesivas(1.0), 1);

	}

	@Test
	public void calcularPotenciaRecursivaNumeroEnteroPositivo() {
		Polinomio pol = new Polinomio(1, new double[1]);
		assertEquals(16.0, pol.potenciaRecursiva(2, 4), 1);
	}
	
	
	@Test
	public void calcularPotenciaRecursivaNumeroEnteroNegativo() {
		Polinomio pol = new Polinomio(1, new double[1]);
		assertEquals(16.0, pol.potenciaRecursiva(-2, 4), 1);
	}
	
	@Test
	public void calcularPotenciaRecursivaNumeroEnteroNegativoExpoImpar() {
		Polinomio pol = new Polinomio(1, new double[1]);
		assertEquals(-32.0, pol.potenciaRecursiva(-2, 5), 1);
	}
	
	
	@Test
	public void calcularPotenciaRecursivaParNumeroEnteroPositivo() {
		Polinomio pol = new Polinomio(1, new double[1]);
		assertEquals(16.0, pol.potenciaRecursiva(-2, 5), 1);
	}
}
